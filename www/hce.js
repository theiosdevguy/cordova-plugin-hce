...
module.exports = {
    ...
    setTrackData: function(trackData, success, failure) {
        cordova.exec(success, failure, 'HCE', 'setTrackData', [trackData]);
    },

    resetTrackData: function(success, failure) {
        cordova.exec(success, failure, 'HCE', 'resetTrackData', []);
    },
